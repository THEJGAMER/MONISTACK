...
COMMAND_TREE = [
    {
        ...
        "items": [
            ...
            {"id": "boot", "label": "Boot / image", "cmd": "show boot system all"},
            {"id": "filesystems", "label": "Filesystems", "cmd": "show file-systems"},
            {"id": "stack_ports", "label": "Stack ports", "cmd": "show system stack-ports"},
            {"id": "hardware_stack", "label": "Hardware stack units", "cmd": "show hardware stack-unit all"},
        ],
    },
    {
        "id": "interfaces",
        ...
        "items": [
            ...
            {"id": "if_counters", "label": "Interface counters (all)", "cmd": "show interfaces counters"},
            {"id": "if_ip_brief", "label": "IP interfaces (brief)", "cmd": "show ip interface brief"},
            {
                "id": "if_counters_port",
                "label": "Counters for a port",
                "cmd": "show interfaces {port} counters",
                "param": "port",
            },
        ],
    },
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "stp_detail", "label": "Spanning Tree (detail)", "cmd": "show spanning-tree 0"},
            {"id": "vlan_brief", "label": "VLANs (brief)", "cmd": "show vlan brief"},
            {"id": "mac_count", "label": "MAC table count", "cmd": "show mac-address-table count"},
            {"id": "storm_control", "label": "Storm control", "cmd": "show storm-control"},
        ],
    },
    {
        "id": "l3",
        ...
        "items": [
            ...
            {"id": "ip_bgp_summary", "label": "BGP summary", "cmd": "show ip bgp summary"},
            {"id": "ip_vrf", "label": "VRFs", "cmd": "show ip vrf"},
            {"id": "ip_ssh", "label": "SSH server", "cmd": "show ip ssh"},
            {"id": "ip_dhcp_binding", "label": "DHCP bindings", "cmd": "show ip dhcp binding"},
        ],
    },
    {
        "id": "ospf",
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "lldp_stats", "label": "LLDP statistics", "cmd": "show lldp statistics"},
        ],
    },
    {
        "id": "logs",
...
JUNOS_COMMAND_TREE = [
    {
        ...
        "items": [
            ...
            {"id": "storage", "label": "Storage", "cmd": "show system storage"},
            {"id": "processes", "label": "Processes (brief)", "cmd": "show system processes brief"},
            {"id": "users", "label": "Logged-in users", "cmd": "show system users"},
            {"id": "ntp", "label": "NTP status", "cmd": "show ntp status"},
            {"id": "virtual_chassis", "label": "Virtual chassis", "cmd": "show virtual-chassis"},
            {"id": "chassis_fpc", "label": "Chassis FPC", "cmd": "show chassis fpc"},
            {"id": "chassis_temps", "label": "Temperature thresholds", "cmd": "show chassis temperature-thresholds"},
            {"id": "system_commit", "label": "Commit history", "cmd": "show system commit"},
            {"id": "log_messages", "label": "Recent log messages", "cmd": "show log messages | last 200"},
        ],
    },
    {
        "id": "interfaces",
        ...
        "items": [
            ...
            {"id": "if_statistics", "label": "Interface statistics", "cmd": "show interfaces statistics"},
            {"id": "if_diag_all", "label": "All optics", "cmd": "show interfaces diagnostics optics"},
            {"id": "poe", "label": "PoE", "cmd": "show poe interface"},
            {"id": "eth_switching_ifaces", "label": "Switching interfaces", "cmd": "show ethernet-switching interfaces"},
            {
                "id": "if_extensive_port",
                "label": "Interface (extensive)",
                "cmd": "show interfaces {port} extensive",
                "param": "port",
            },
        ],
    },
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "stp_interface", "label": "Spanning Tree (interfaces)", "cmd": "show spanning-tree interface"},
            {"id": "vlans_extensive", "label": "VLANs (extensive)", "cmd": "show vlans extensive"},
            {"id": "mac_learning_log", "label": "MAC learning log", "cmd": "show ethernet-switching mac-learning-log"},
        ],
    },
    {
        "id": "neighbors",
        ...
        "items": [
            ...
            {
                "id": "lldp_port",
                "label": "LLDP neighbour on a port",
                "cmd": "show lldp neighbors interface {port}",
                "param": "port",
            },
            {"id": "lldp_stats", "label": "LLDP statistics", "cmd": "show lldp statistics"},
        ],
    },
    {
        ...
        "label": "Layer 3",
        "items": [
            {"id": "route", "label": "Routing table", "cmd": "show route"},
            {"id": "route_summary", "label": "Route summary", "cmd": "show route summary"},
            {"id": "arp", "label": "ARP table", "cmd": "show arp"},
            {"id": "ospf_neighbor", "label": "OSPF neighbours", "cmd": "show ospf neighbor"},
            {"id": "bgp_summary", "label": "BGP summary", "cmd": "show bgp summary"},
        ],
    },
]
